...
///This [InheritedWidget] holds a [Counter] object to store the
///state of the counter app
class CounterState extends InheritedWidget {
  ...
  ///Looks for the closest [CounterState] instance up in the widget tree
  ///and returns it. Throws if no matches are found
